...
<details>
<summary><strong>🗝️ How to obtain required API keys</strong></summary>
...
# 3️⃣ Optional: Use PM2 for process management
npm install -g pm2
...
|:---:|:---:|:---:|
| ![Dashboard](Video/frontendIMG.png) | ![AI Mentor](Video/MentorAI.png) | ![Tutorials](Video/frontendIMG.png) |
...
<details>
<summary><strong>🏗️ Server-side Implementation</strong></summary>
...
<details>
<summary><strong>⚡ Live Updates & Interactions</strong></summary>
...
<img src="Video/MentorAI.png" alt="AI Mentor Chat" style="width:100%; border-radius:8px;"/>
